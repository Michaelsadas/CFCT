...
public:
    ...
    int preTime() { return _preTime; }
    void setPreloadTime(int time) { _preTime = time; }
    int waitTime() { return _waitTime; }
    void setWaitTime(int time) { _waitTime = time; }
    int storeTime() { return _storeTime; }
    void setStoreTime(int time) { _storeTime = time; }
    bool useSerial() { return _useSerial; }
    void setUseSerial (bool useSerial) { _useSerial = useSerial; }
    bool useAccum() { return _useAccum; }
    void setUseAccum(bool useAccum) { _useAccum = useAccum; }
