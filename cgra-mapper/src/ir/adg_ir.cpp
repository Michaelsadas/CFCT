    ...
    if(type == "GPE" || type == "GIB" || type == "IOB"){
        ...
        if(type == "GPE" || type == "IOB"){
            ...
            if(type == "GPE"){
                ...
                if(iocCfgId.contains("UseAccum")){
                    node->cfgIdMap["UseAccum"] = iocCfgId["UseAccum"].get<int>();
                }
                if(iocCfgId.contains("Waittime")){
                    node->cfgIdMap["Waittime"] = iocCfgId["Waittime"].get<int>();
                }
                if(iocCfgId.contains("Preloadtime")){
                    node->cfgIdMap["Preloadtime"] = iocCfgId["Preloadtime"].get<int>();
                }
                if(iocCfgId.contains("Storetime")){
                    node->cfgIdMap["Storetime"] = iocCfgId["Storetime"].get<int>();
                }
                if(iocCfgId.contains("UseSerial")){
                    node->cfgIdMap["UseSerial"] = iocCfgId["UseSerial"].get<int>();
                }
                fu_node = node;
            }
