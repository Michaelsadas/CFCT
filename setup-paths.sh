...
if [ ! -f ../chipyard/src/main/scala/config/cdnnSoCConfigs.scala ]; then
    sed '1d; $d' $PWD/hardware-generator/src/main/scala/soc/cdnnSoCConfigs.scala > ../chipyard/src/main/scala/config/cdnnSoCConfigs.scala
fi
